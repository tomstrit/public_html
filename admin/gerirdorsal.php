...
$table->setTitle("Adicionar dorsal");

//select the table in the datebase
//SELECT `CodigoDorsal`, `Numero`, `CodigoAtleta`, `CodigoProva` FROM `Dorsal` WHERE 1
$table->prepareTable("Dorsal");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("Numero, CodigoAtleta, CodigoProva",'list');
$table->setFieldsAtive("Numero, CodigoAtleta, CodigoProva", 'new');
$table->setFieldsAtive("Numero, CodigoAtleta, CodigoProva", 'edit');
$table->setFieldsAtive("Numero, CodigoAtleta, CodigoProva", 'csv');
