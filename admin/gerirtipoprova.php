...
$table->setTitle("Adicionar tipo de prova");

//select the table in the datebase
//SELECT `CodigoTipoProva`, `Tipo` FROM `TipoProva` WHERE 1
$table->prepareTable("TipoProva");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("CodigoTipoProva, Tipo",'list');
