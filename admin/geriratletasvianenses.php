...
$table->setTitle("Adicionar atleta vianense:");

//select the table in the datebase
//SELECT `CodigoVianense`, `Nome`, `Descricao`, `Foto` FROM `AtletasVianenses` WHERE 1
$table->prepareTable("AtletasVianenses");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("Nome, Descricao, Foto",'list');
$table->setFieldsAtive("Nome, Descricao, Foto", 'new');
$table->setFieldsAtive("Nome, Descricao, Foto", 'edit');
$table->setFieldsAtive("Nome, Descricao, Foto", 'csv');
