...
$table->setTitle("Adicionar desporto");

//select the table in the datebase
//SELECT `CodigoDesporto`, `Nome`, `Descrição`, `Foto` FROM `Desportos` WHERE 1
$table->prepareTable("Desportos");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("Nome, Foto, Descrição",'list');
$table->setFieldsAtive("Nome, Foto, Descrição", 'new');
$table->setFieldsAtive("Nome, Foto, Descrição", 'edit');
$table->setFieldsAtive("Nome, Foto, Descrição", 'csv');
