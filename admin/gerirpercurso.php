...
$table->setTitle("Percursos");

//select the table in the datebase
//SELECT `CodigoPercurso`, `Nome`, `Descricao`, `DataInicio`, `CodigoProva` FROM `Percurso` WHERE 1
$table->prepareTable("Percurso");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("Nome, Descricao, DataInicio, CodigoProva",'list');
$table->setFieldsAtive("Nome, Descricao, DataInicio, CodigoProva", 'new');
$table->setFieldsAtive("Nome, Descricao, DataInicio, CodigoProva", 'edit');
$table->setFieldsAtive("Nome, Descricao, DataInicio, CodigoProva", 'csv');
