...
$table->setTitle("Dispositivos LoRa");

//select the table in the datebase
//SELECT `CodigoLora`, `Descricao`, `CodigoAtleta` FROM `Lora` WHERE 1
$table->prepareTable("Lora");

//list of fields for list, new, edit and import records
$table->setFieldsAtive("CodigoLora, Descricao, CodigoAtleta",'list');
$table->setFieldsAtive("Descricao, CodigoAtleta", 'new');
$table->setFieldsAtive("Descricao, CodigoAtleta", 'edit');
$table->setFieldsAtive("Descricao, CodigoAtleta", 'csv');
